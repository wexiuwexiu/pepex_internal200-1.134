...
__forceinline bool OptimalPitch(const PredictCtx& Ctx, const Vector2& Dir2D, float* OutPitch) {
...
__forceinline bool SolveTrajectory(PredictCtx& Ctx, const Vector3& ExtrPos, float* TravelTime)
{
